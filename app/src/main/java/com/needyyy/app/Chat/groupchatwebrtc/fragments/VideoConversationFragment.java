...
import com.needyyy.app.Chat.groupchatwebrtc.adapters.OpponentsFromCallAdapter;
    ...
    private void switchCamera(final MenuItem item) {
        ...
        conversationFragmentCallbackListener.onSwitchCamera(new CameraVideoCapturer.CameraSwitchHandler() {
            ...
            public void onCameraSwitchError(String s) {
                ...
                Toast.makeText(AppController.getInstance().getApplicationContext(),getString(R.string.camera_swicth_failed) + s, Toast.LENGTH_SHORT).show();
