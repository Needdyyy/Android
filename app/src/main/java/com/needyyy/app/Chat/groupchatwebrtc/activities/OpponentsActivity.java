...
import com.needyyy.app.Chat.groupchatwebrtc.adapters.OpponentsAdapter;
...
import com.needyyy.app.Chat.groupchatwebrtc.utils.CollectionsUtils;
...
public class OpponentsActivity extends BaseActivity implements View.OnClickListener {
    private static final String TAG = OpponentsActivity.class.getSimpleName();
     private ImageView ivVideoCall,ivAudioCall;
