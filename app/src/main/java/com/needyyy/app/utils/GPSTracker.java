...
public class GPSTracker extends Service implements LocationListener {
    ...
    public void showSettingsAlert(){
        ...
        alertDialog.setTitle(mContext.getResources().getString(R.string.gps_setting));

        // Setting Dialog Message
        alertDialog.setMessage(mContext.getResources().getString(R.string.gpsnotenablemsg));
