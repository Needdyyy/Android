...
public class Allmember extends BaseFragment implements View.OnClickListener, SearchListener {
    ...
    public static Allmember newInstance() {
        Allmember allmember = new Allmember();
        Bundle args = new Bundle();
        allmember.setArguments(args);
        return allmember;
    }
    ...
    protected void initView(View mView) {
        ...
        ((HomeActivity)getActivity()).manageToolbar("All Members", "");
    ...
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState, R.layout.allmember);
    ...
    private void setKnockFriendAdapter() {
        ...
        knockRequestAdapter = new KnockRequestAdapter(getActivity(),arrGetRequests,1);
...
//        rvKnockrequest.addItemDecoration(dividerItemDecoration);
    ...
    public void getRequestList(String text,Boolean status) {
        ...
        Call<GetReceivedRequest> call = Service.GetAllMember("10", String.valueOf(mPage),text);
...
//                        snackBar(getReceivedRequest.getMessage());
    ...
    public void setUserVisibleHint(boolean isVisibleToUser){
        ...
        if(isVisibleToUser && isAttached){ //if listener is called before fragment is attached will throw NPE
            ...
            mapFragmentVisibilityListener.fragmentVisible(true,Allmember.this);
        }
    }
