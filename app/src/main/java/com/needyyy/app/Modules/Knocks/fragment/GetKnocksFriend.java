...
public class GetKnocksFriend extends BaseFragment implements View.OnClickListener, SearchListener {
...
//        rvKnockrequest.addItemDecoration(dividerItemDecoration);
    ...
    public void getRequestList(String search,Boolean status) {
//        showProgressDialog();
        WebInterface Service = AppController.getRetrofitInstance(false).create(WebInterface.class);
        Call<GetReceivedRequest> call = Service.GetFriends("20", String.valueOf(mPage),search);
...
//                        snackBar(getReceivedRequest.getMessage());
    ...
    public void setUserVisibleHint(boolean isVisibleToUser){
        ...
        if(isVisibleToUser && isAttached){ //if listener is called before fragment is attached will throw NPE
            ...
            mapFragmentVisibilityListener.fragmentVisible(true,GetKnocksFriend.this);
        }
    }
