...
public class GetSendKnocks  extends BaseFragment implements View.OnClickListener, SearchListener {
    ...
    TextView tvNoResult;
    public static GetSendKnocks newInstance() {
        GetSendKnocks getSendKnocks = new GetSendKnocks();
        Bundle args = new Bundle();
        getSendKnocks.setArguments(args);
        return getSendKnocks;
    }
    @Override
    ...
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState, R.layout.fragment_get_send_knocks);
    ...
    private void setKnockFriendAdapter() {
        knockRequestAdapter = new KnockRequestAdapter(getActivity(),arrGetRequests,4);
...
//        showProgressDialog();
        ...
        Call<GetReceivedRequest> call = Service.GetSentKnocks("20", String.valueOf(mPage),text);
...
//                        snackBar(getReceivedRequest.getMessage());
    ...
    public void setUserVisibleHint(boolean isVisibleToUser){
        ...
        if(isVisibleToUser && isAttached){ //if listener is called before fragment is attached will throw NPE
            ...
            mapFragmentVisibilityListener.fragmentVisible(true,GetSendKnocks.this);
        }
    }
